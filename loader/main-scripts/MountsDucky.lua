...
local CheckPoints = {
    Spawn = {x = 1450, y = -18, z = -1784},
    ["Pos - 1"] = {x = 741, y = 196, z = -797},
    ["Pos - 2"] = {x = 196, y = 271, z = -801},
    ["Pos - 3"] = {x = -121, y = 224, z = -767},
    ["Pos - 4"] = {x = 15, y = 218, z = -377},
    ["Pos - 5"] = {x = 219, y = 220, z = 664},
    ["Pos - 6"] = {x = -214, y = 496, z = 1025},
    ["Pos - 7"] = {x = -732, y = 696, z = 823},
    ["Pos - 8"] = {x = -1320, y = 668, z = 1243},
    ["Pos - 9"] = {x = -1510, y = 712, z = 1645},
    ["Pos - 10"] = {x = -1663, y = 833, z = 1901},
    ["Pos - 11"] = {x = -2009, y = 926, z = 2477},
    Puncak = {x = -1960, y = 861, z = 2765}
}
...
local teleportSequence = {"Spawn", "Pos - 1", "Pos - 2", "Pos - 3", "Pos - 4", "Pos - 5", "Pos - 6", "Pos - 7", "Pos - 8", "Pos - 9", "Pos - 10", "Pos - 11", "Puncak"}
