...
-- checkpoint
local CheckPoints = {
    Spawn = {x = 73, y = 188, z = 917},
    ["Pos - 1"] = {x = -83, y = 180, z = 351},
    ["Pos - 2"] = {x = -270, y = 168, z = 10},
    ["Pos - 3"] = {x = 187, y = 170, z = -457},
    ["Pos - 4"] = {x = -235, y = 184, z = -785},
    ["Pos - 5"] = {x = -191, y = 204, z = -1206},
    ["Pos - 6"] = {x = -993, y = 206, z = -1076},
    ["Pos - 7"] = {x = -1135, y = 204, z = -553},
    ["Pos - 8"] = {x = -1026, y = 352, z = -442},
    ["Pos - 9"] = {x = -1089, y = 198, z = -156},
    ["Pos - 10"] = {x = -1101, y = 352, z = 61},
    ["Pos - 11"] = {x = -1103, y = 184, z = 400},
    ["Pos - 12"] = {x = -828, y = 184, z = 792},
    ["Pos - 13"] = {x = -1016, y = 245, z = 1270},
    ["Pos - 14"] = {x = -1710, y = 240, z = 1586},
    ["Pos - 15"] = {x = -1303, y = 232, z = 1644},
    ["Pos - 16"] = {x = -923, y = 199, z = 1852},
    ["Pos - 17"] = {x = -453, y = 200, z = 1847},
    ["Pos - 18"] = {x = 292, y = 176, z = 1649},
    ["Pos - 19"] = {x = 712, y = 168, z = 1542},
    ["Pos - 20"] = {x = 1202, y = 184, z = 1580},
    ["Pos - 21"] = {x = 1705, y = 223, z = 937},
    ["Pos - 22"] = {x = 1675, y = 304, z = 481},
    ["Pos - 23"] = {x = 1515, y = 221, z = 109},
    ["Pos - 24"] = {x = 1497, y = 208, z = -808},
    ["Pos - 25"] = {x = 1327, y = 366, z = -1210},
    ["Pos - 26"] = {x = 1220, y = 504, z = -1475},
    ["Pos - 27"] = {x = 1042, y = 548, z = -1566},
    ["Pos - 28"] = {x = 1099, y = 812, z = -1707},
    Puncak = {x = 1314, y = 984, z = -2033},
    ["Balik Basecamp"] = {x = 1368, y = 989, z = -1981}
}

local isAutoTeleporting = false
local isAutoRespawnEnabled = false
local currentDelay = 3
local teleportSequence = {"Spawn", "Pos - 1", "Pos - 2", "Pos - 3", "Pos - 4", "Pos - 5", "Pos - 6", "Pos - 7", "Pos - 8", "Pos - 9", "Pos - 10", "Pos - 11", "Pos - 12", "Pos - 13", "Pos - 14", "Pos - 15", "Pos - 16", "Pos - 17", "Pos - 18", "Pos - 19", "Pos - 20", "Pos - 21", "Pos - 22", "Pos - 23", "Pos - 24", "Pos - 25",  "Pos - 26", "Pos - 27", "Pos - 28", "Puncak", "Balik Basecamp"}
...
-- NEW: Infinite teleport loop function
local function InfiniteTeleportLoop()
    ...
    while isAutoTeleporting do
        ...
        for _, checkpoint in ipairs(teleportSequence) do
            ...
            -- Jika sampai di Puncak dan Auto Respawn aktif
            if checkpoint == "Puncak" and isAutoRespawnEnabled then
                GUI.statusText.Text = "Status: Summit Reached, Auto respawn 2s (Loop " .. loopCount .. ")"
                GUI.statusText.TextColor3 = Colors.Danger
                
                -- Tunggu sebentar sebelum respawn
                for i = 1, 2 do
                    if not isAutoTeleporting then break end
                    GUI.statusText.Text = "Status: Respawn in " .. (3 - i) .. "s (Loop " .. loopCount .. ")"
                    task.wait(1)
                end
                ...
                if isAutoTeleporting then
                    ...
                    GUI.statusText.Text = "Status: Respawn success (Loop " .. loopCount .. ")"
                    
                    -- Tunggu karakter respawn
                    character = player.CharacterAdded:Wait()
                    humanoidRootPart = character:WaitForChild("HumanoidRootPart")
                    
                    -- Tunggu sedikit setelah respawn sebelum melanjutkan loop
                    task.wait(2)
                end
            else
                -- Delay normal antar checkpoint (kecuali checkpoint terakhir dengan auto respawn)
                if checkpoint ~= "Puncak" or not isAutoRespawnEnabled then
...
print("✅ XuKrost Hub Successfully loaded! Infinite loop mode activated!")