...
-- checkpoint
local CheckPoints = {
    Spawn = {x = 239, y = 12, z = -990},
        ["Pos - 1"] = {x = 513, y = 159, z = -530},
           ["Pos - 2"] = {x = 387, y = 308, z = -185},
              ["Pos - 3"] = {x = 100, y = 410, z = 614},
                 ["Pos - 4"] = {x = 11, y = 599, z = 998},
                 ["Pos - 5"] = {x = 873, y = 863, z = 581},
              ["Pos - 6"] = {x = 1618, y = 1079, z = 157},
           ["Pos - 7"] = {x = 2970, y = 1525, z = 708},
        ["Pos - 8"] = {x = 1945, y = 1742, z = 1225},
    Puncak = {x = 1802, y = 1980, z = 2168}
}
