...
-- checkpoint
local CheckPoints = {
    Spawn = {x = 113, y = 84, z = 100},
    ["Pos - 1"] = {x = 276, y = 84, z = 248},
    ["Pos - 2"] = {x = 584, y = 275, z = -56},
    ["Pos - 3"] = {x = 1201, y = 273, z = 292},
    ["Pos - 4"] = {x = 1551, y = 286, z = 290},
    ["Pos - 5"] = {x = 1819, y = 326, z = -9},
    ["Pos - 6"] = {x = 2259, y = 397, z = 110},
    ["Pos - 7"] = {x = 3166, y = 512, z = 335},
    ["Pos - 8"] = {x = 3670, y = 494, z = 251},
    ["Pos - 9"] = {x = 4221, y = 492, z = 516},
    ["Pos - 10"] = {x = 4415, y = 708, z = 810},
    ["Pos - 11"] = {x = 4370, y = 701, z = 1875},
    ["Pos - 12"] = {x = 5026, y = 445, z = 2444},
    ["Pos - 13"] = {x = 5225, y = 447, z = 3077},
    ["Pos - 14"] = {x = 5252, y = 446, z = 3865},
    ["Pos - 15"] = {x = 5313, y = 693, z = 4058},
    ["Pos - 16"] = {x = 5430, y = 1095, z = 4401},
    Puncak = {x = 5263, y = 1165, z = 4749}
}

local isAutoTeleporting = false
local isAutoRespawnEnabled = false
local currentDelay = 3
local teleportSequence = {"Spawn", "Pos - 1", "Pos - 2", "Pos - 3", "Pos - 4", "Pos - 5", "Pos - 6", "Pos - 7", "Pos - 8", "Pos - 9", "Pos - 10", "Pos - 11", "Pos - 12", "Pos - 13", "Pos - 14", "Pos - 15", "Pos - 16", "Puncak"}
