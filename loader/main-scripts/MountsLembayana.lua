...
-- checkpoint
local CheckPoints = {
    Spawn = {x = 599, y = 267, z = 516},
    Puncak = {x = -23430, y = 6353, z = -6908}
}

local isAutoTeleporting = false
local currentDelay = 3
local teleportSequence = {"Spawn", "Puncak"}
...
local function CreateGUI()
    ...
    delayLabel.Position = UDim2.new(0, 20, 0, -5)
...
local function AutoTeleport()
    while isAutoTeleporting do
        for _, checkpoint in ipairs(teleportSequence) do
            ...
            -- Delay sebelum teleport berikutnya
        ...
        -- Loop akan terus berjalan selama isAutoTeleporting true
        if isAutoTeleporting then
            GUI.statusText.Text = "Status: Looping..."
